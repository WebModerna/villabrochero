<?php
	...
	$asunto			=	__('Solicitud de Servicios', 'villabrochero');
	$cuerpo			=	'
							...
							<tbody>
								<tr>
									...
									<td bgcolor="#006553" align="right" color="#eeeeee">
										<h1>'; $cuerpo .= $nombre_sitio.'</h1>
									</td>
								</tr>
								<tr>
									<td colspan="2" align="center">
										<h2>Solicitud de Servicios Inmobiliarios</h2>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2" bgcolor="#eeeeee" align="left">
										<strong>Localización preferida: </strong>';
										$cuerpo .=$_POST['loc'];
										$cuerpo .='
									</td>
								</tr>
								<tr>
									<td colspan="2" align="left">
										<strong>Otras localizaciones posibles: </strong>';
										$cuerpo .=$_POST['otr'];
										$cuerpo .='
									</td>
								</tr>
								<tr>
									<td colspan="2" bgcolor="#eeeeee" align="left">
										...
										$cuerpo .=$_POST['sup'];
										$cuerpo .=' Mts<sup>2</sup>
									</td>
								</tr>
								<tr>
									<td colspan="2" align="left">
										<strong>Valor Aproximado en $: </strong>';
										$cuerpo .=$_POST['val'];
										$cuerpo .='
									</td>
								</tr>
								<tr>
									<td colspan="2" bgcolor="#eeeeee" align="left">
										<strong>Valor Aproximado en U$s: </strong>';
										$cuerpo .=$_POST['val_dolar'];
										$cuerpo .='
									</td>
								</tr>
								<tr>
									<td colspan="2" align="left">
										<strong>Fin Principal del Inmueble: </strong>';
										$cuerpo .=$_POST['fin'];
										$cuerpo .='
									</td>
								</tr>
