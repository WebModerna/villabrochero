...
class RWMB_Date_Field extends RWMB_Text_Field
{
	...
	*/
	static function admin_enqueue_scripts()
	{
		...
		// CArga del multi daptepick
		if ( is_admin() )
		{ // para que solo haga la carga si no es el área de admin
		// registra la ubicación, dependencias y versión de su script.
			wp_register_script('datpicke', get_bloginfo('template_directory') . '/includes/meta-box/js/jqueryui/jquery.datepick.js', true);
