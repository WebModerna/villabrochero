...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repetir', 'villabrochero' ),
		'repeat-x'  => __( 'Repetir Horizontalmente', 'villabrochero' ),
		'repeat-y'  => __( 'Repetir Verticalmente', 'villabrochero' ),
		'repeat'    => __( 'Repetir todo', 'villabrochero' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Arriba Izquierda', 'villabrochero' ),
		'top center'    => __( 'Arriba Centro', 'villabrochero' ),
		'top right'     => __( 'Arriba Derecha', 'villabrochero' ),
		'center left'   => __( 'Medio Izquierda', 'villabrochero' ),
		'center center' => __( 'Medio Centro', 'villabrochero' ),
		'center right'  => __( 'Medio Derecha', 'villabrochero' ),
		'bottom left'   => __( 'Abajo Izquierda', 'villabrochero' ),
		'bottom center' => __( 'Abajo Centro', 'villabrochero' ),
		'bottom right'  => __( 'Abajo Derecha', 'villabrochero')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Desplazamiento Normal', 'villabrochero' ),
		'fixed'  => __( 'Estático en un lugar', 'villabrochero')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'villabrochero' ),
		'italic'      => __( 'Cursiva', 'villabrochero' ),
		'bold'        => __( 'Negrita', 'villabrochero' ),
		'bold italic' => __( 'Negrita Cursiva', 'villabrochero' )
		);
