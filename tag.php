		...
		<div class="main">
			<main>
				...
				<header class="main--header">
					<h2><?php printf( __( '%s', 'villabrochero' ), single_tag_title( '', false ) );  _e(': '); echo '<strong>'.$count = $wp_query->post_count.'</strong>';?></h2>
				</header>
				<?php global $wp_query;
				query_posts(
					array_merge(
				...
				<section>
					<article class="contenido">
						<blockquote>
							<?php _e('No hay productos cargados ni publicados bajo esta etiqueta.', 'villabrochero');?>
						</blockquote>
